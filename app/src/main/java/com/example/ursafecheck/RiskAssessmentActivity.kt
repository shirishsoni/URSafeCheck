...
//            val rb1_ques = ra_rb1_title.text.toString().trim()
//            val rb2_ques = ra_rb2_title.text.toString().trim()
//            val rb3_ques = ra_rb3_title.text.toString().trim()
//            val rb4_ques = ra_rb4_title.text.toString().trim()
//            val rb5_ques = ra_rb5_title.text.toString().trim()
//            val rb6_ques = ra_rb6_title.text.toString().trim()
//            val rb7_ques = ra_rb7_title.text.toString().trim()
//            val rb8_ques = ra_rb8_title.text.toString().trim()
//            val rb9_ques = ra_rb9_title.text.toString().trim()
//            val rb10_ques = ra_rb10_title.text.toString().trim()
//            val rb11_ques = ra_rb11_title.text.toString().trim()
//            val rb12_ques = ra_rb12_title.text.toString().trim()
//            val rb13_ques = ra_rb13_title.text.toString().trim()
//            val rb14_ques = ra_rb14_title.text.toString().trim()
//            val rb15_ques = ra_rb15_title.text.toString().trim()
//            val rb16_ques = ra_rb16_title.text.toString().trim()
//            val rb17_ques = ra_rb17_title.text.toString().trim()
//            val rb18_ques = ra_rb18_title.text.toString().trim()
//            val rb19_ques = ra_rb19_title.text.toString().trim()
//            val rb20_ques = ra_rb20_title.text.toString().trim()
